...
parse_target "S:work/api"
assert_eq "session" "$TARGET_KIND" "parse_target session kind"
assert_eq "work/api" "$TARGET_VALUE" "parse_target session value"
parse_target "W:/tmp/worktrees/repo/feat"
assert_eq "dir" "$TARGET_KIND" "parse_target worktree kind"
assert_eq "/tmp/worktrees/repo/feat" "$TARGET_VALUE" "parse_target worktree value"
parse_target "F:/tmp/worktrees/features/checkout"
assert_eq "dir" "$TARGET_KIND" "parse_target feature kind"
assert_eq "/tmp/worktrees/features/checkout" "$TARGET_VALUE" "parse_target feature value"
parse_target "/bare/path"
assert_eq "dir" "$TARGET_KIND" "parse_target bare path kind"
assert_eq "/bare/path" "$TARGET_VALUE" "parse_target bare path value"
